		...
		<div className={styles.calculator}>
			<div className={styles.calculator__inner}>
				...
				<div className={styles.buttons}>
					...
					<button onClick={() => setValue((updateValue) => updateValue + '-')} className={styles.symbols}>-</button>
					<button onClick={() => setValue((updateValue) => eval(updateValue))} className={styles.symbols}>=</button>
					<button onClick={() => setValue(() => setValue(''))} className={styles.symbols}>C</button>
				</div>
